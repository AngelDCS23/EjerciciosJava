...
public class Ejer8 {
	...
	public static void main(String[] args) {
		...
		BufferedReader br = new BufferedReader(new FileReader("//Users//angeldecarasalas//1//nombreyapellidos.txt")); //Con esto podremos leer el archivo seleccionado.
		...
		BufferedReader br3 = new BufferedReader(new FileReader("//Users//angeldecarasalas//1//datoscompletos2.txt"));
